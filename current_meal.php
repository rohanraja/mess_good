...
function create_item_td($f_name, $f_price)
{
	...
	if(!$f_price)
		return '<td onclick="" class="no_entry" style=""><b class="">None'.'</b><a href="#" ><img src="css/img/Check-icon.png" class="img-rounded"></a><br>₹ <span class="i_price">0'.'</span></td>';
		
	return '<td onclick="on_td_click(this)" class="" style=""><b class="">'.$f_name.'</b><a href="#" ><img src="css/img/Check-icon.png" class="img-rounded"></a><br>₹ <span class="i_price">'.$f_price.'</span></td>';
