...
// 	
  ...
  `price` double NOT NULL
		...
		mysql_query("INSERT INTO meals_b (SELECT * FROM pat_mess_7_13.meals_b)");
		mysql_query("INSERT INTO meals_l (SELECT * FROM pat_mess_7_13.meals_l)");
		mysql_query("INSERT INTO meals_s (SELECT * FROM pat_mess_7_13.meals_s)");
		mysql_query("INSERT INTO meals_d (SELECT * FROM pat_mess_7_13.meals_d)");
